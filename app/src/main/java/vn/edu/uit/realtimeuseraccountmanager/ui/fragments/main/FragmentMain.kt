...
import vn.edu.uit.realtimeuseraccountmanager.ui.adapter.AdapterUser
import java.util.*
import kotlin.collections.ArrayList

class FragmentMain : Fragment(), FragmentMainListener, IManagement {

    private val adapterUser: AdapterUser by lazy {
        AdapterUser(requireActivity(), mutableListOf())
    }
        ...
        searchview_name.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            ...
            override fun onQueryTextChange(newText: String?): Boolean {
                if (!newText.isNullOrEmpty())
                    ...
                    adapterUser.updateData(viewModel.listUser.value!!)
                return true
            }
        })
